...
<%@ page import="org.wso2.carbon.governance.resourcecompare.ui.ResourceComparator" %>
<%@ page import="org.wso2.carbon.governance.resourcecompare.ui.utils.ResourceExtensionValidator" %>
...
<% } else {
    ...
    String result = rc.getDiffViewType(resource1Path, resource2Path);
    if (null != result) {
        ResourceExtensionValidator fev = new ResourceExtensionValidator();
        // Get resource type
        type = fev.getFileExtension(resource1Path);
        // Membrane result
